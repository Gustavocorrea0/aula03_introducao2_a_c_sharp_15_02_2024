...
using UMFG.ProgramacaoIV.Dominio.Exetensoes;
    ...
    public sealed class Cliente : AbstractEntidade
    {
        ...
        */
        ...
        public void apresentaDados() {
            ...
            Console.WriteLine(DataAlteracao);
            Console.WriteLine(UsuarioAlteracao);
            Console.WriteLine(UsuarioCadastro);
        }
